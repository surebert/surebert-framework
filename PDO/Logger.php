 ...
 * 
 * @Author Paul Visco
 * @Version 1.8 09/27/2007 01/28/2009
 * 
 */
 ...
 * 
 */
class sb_PDO_Logger extends sb_PDO{
	...
	public function set_logger($logger=null){
		...
		if($logger instanceOf sb_Logger){
			$this->logger = $logger;
			$this->logger->add_log_type('sb_PDO_Logger');
		} else {
			$this->logger = new sb_Logger_FileSystem('sb_PDO_Logger');
		}
	...
	public function write_to_log($message){
		...
		return $this->logger->sb_PDO_Logger($message);
	}
