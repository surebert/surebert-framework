(function(){
	...
	@Version: 4.10 04/24/04 05/27/08
	@Package: surebert
	*/
	var sb = {
		...
		*/
		...
		e.g. s$('ol li').css('background-color', 'blue').addClassName('selected');
		...
		*/
		...
		/**
		@Name: sb.external
		@Description: Used Internally. A placeholder for sb.external
		*/
		external : {},
		/**
		@Name: sb.forms
	...
	*/
	...
	sb.nodeList = function(nodes){
		...
		sb.objects.infuse(sb.nodeList.methods, nodes);
	...
	sb.nodeList.methods = {
		...
		*/
		...
		/**
		@Name: sb.nodeList.prototype.styles
		@Description: Sets the styles of every element in the nodeList 
		@Example: 
		s$('ol li').styles({
			backgroundColor : 'red'
		});
	...
	*/
	...
	sb.element.prototype = {
		...
		*/
		...
		/**
		@Name: sb.element.prototype.addDimensions
		@Description: Adds widtha nd height properties to an to an element and then returns the element itself
		@Param: String c The classname to add
		@Example:
		myElement.addDimensions();
		...
		*/
		...
		/**
		@Name: sb.element.prototype.addPosition
		...
		*/
		...
		/**
		@Name: sb.element.prototype.addPositionRelative
		@Description: Used to calculate the bounds top, right, bottom, left, height, and width of a DOM node in distance its parent node
		@Return: Object An object with top, right, bottom, left, h, and w properties
		
		@Example:
		var pos = myElement.addPositionRelative();
		alert(pos.left);
		*/
		...
		/**
		@Name: sb.element.prototype.addPositionMinusScroll
		@Description: Used to calculate the bounds top, right, bottom, left, height, and width of a DOM node.   Attaches those properties to the element itself
		@Return: Object An object with top, right, bottom, left, h, and w properties. Returns numbers minus the scroll position, so that they accurately describe screen position
		
		@Example:
		var pos = myElement.addPositionMinusScroll();
		alert(pos.top);
		*/
		...
		*/
		mv : function(x,y,z){
			...
			if(this.css('position') == 'static'){this.style.position = 'absolute';}
			
			this.addPosition();
		},
		
		/**
		@Name: sb.element.prototype.opacity
		...
		*/
		styles : function(params){
			try{
				sb.objects.infuse(params, this.style);
			} catch(e){}
		},
