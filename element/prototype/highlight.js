...
/**
@Name:  sb.element.prototype.highlight
...
var highlight = s$('#new_element').highlight({startColor : '#FF9999', duration : 500, onEnd : function(){
	alert('done');
}});
*/
sb.element.prototype.highlight = function(o){
