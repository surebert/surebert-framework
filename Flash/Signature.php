...
class sb_Flash_Signature{
	...
	public function __construct($id=null, $db=null){
		...
		if(empty($this->ip)){
			//set the Flash_Signature IP addr to that of the user who created the Flash_Signature
	 ...
	 * * @param integer $width The width of the Flash_Signature, specified in pixels
	 * @param integer $height The height of the Flash_Signature, specified in pixels
	 * @param integer $thickness  The Flash_Signature line thickness
	 * @param array $background_color The background color of the Flash_Signatures specified as an Array(r,g,b) e.g. Array(255,0,45);
