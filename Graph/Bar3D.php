...
class Graph_Bar3D{
    ...
    public function draw(){
        ...
        for($i=0;$i<$columns;$i++)$maxv = max($this->values[$i],$maxv);
        ...
        for($i=0;$i<$columns;$i++){
            ...
            $y2 = $this->height;
            imagefilledrectangle($this->graph,$x1,$y1,$x2,$y2,$this->colors->front);
        ...
        // Draw the value on
        imagestring($this->graph, 2, $x1+2, $y1+2, $this->values[$i], $this->colors->text);
