...
class sb_Validate{
	 ...
	 * @return sb_ValidationResults
	 */
	public static function email($email, $check_mx_records=true){
	
		$result = new sb_ValidationResults();
		$result->value = $email;
	 ...
	 * @return sb_ValidationResults The message property includes the city if it exists
	 */
