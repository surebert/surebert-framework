 ...
 * </code>
 *
 * Then put this in your png or php file that will be the src for the image in your form
 * 
 * <code>
 * <?php
//start the session
	...
	public function draw($filters=Array()){
		...
		for($j=0;$j<5;$j++){
			...
			if(file_exists($this->font)){
				imagettftext($this->image, rand(8,18), rand(0,30), rand(0,200), rand(0,200), $this->ink_color, $this->font, 'not the word');
			} else {
				imagestring($this->image, rand(1,4), rand(0,200), rand(0,200), 'not the word', $this->ink_color );
			}
		}
		...
		if(file_exists($this->font)){
			...
			imagestring($this->image, 50, rand(10,80), rand(80,120), $this->word, $this->ink_color );
		}
