<?php
class sb_Webservices_WeatherGovParametersType {
  public $maxt; // boolean
  public $mint; // boolean
  public $temp; // boolean
  public $dew; // boolean
...
/**
 * sb_Webservices_WeatherGov class  This is used to lookup weather information
 * 
 * @author    {author}
 * @copyright {copyright}
 * @package   {package}
 * 
 * <code>
 * $weather = new sb_Webservices_WeatherGov();
 * $result = $weather->LatLonListZipCode(14209);
 * </code>
 */
class sb_Webservices_WeatherGov extends SoapClient {

  private static $classmap = array(
                                    'weatherParametersType' => 'sb_Webservices_WeatherGovParametersType',
                                   );
